    ...
    <div className="flex flex-col h-[calc(100vh-6rem)]">
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col gap-4 overflow-auto min-w-0">
          ...
          {/* Value Field */}
          <div className="bg-white rounded-2xl border border-gray-200/60 px-4 py-3">
        ...
        <div className="w-64 lg:w-72 bg-white rounded-2xl border border-gray-200/60 flex flex-col overflow-hidden shrink-0 hidden lg:flex">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 py-6 gap-4">
            ...
            <div className="text-center">
              <p className="text-[32px] font-bold text-gray-900 tabular-nums font-mono leading-none">
            ...
            <div className="mt-2 text-center">
              ...
              <p className={cn('text-[14px] font-semibold', wouldNotify ? 'text-gray-900' : 'text-gray-300')}>

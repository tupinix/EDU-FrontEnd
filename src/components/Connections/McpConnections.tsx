    ...
    <div className="space-y-5">
      ...
      {createdToken && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/60 dark:border-gray-800 shadow-xl w-full max-w-lg max-h-[85vh] flex flex-col">
            {/* Header */}
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 shrink-0">
              <div className="flex items-center justify-between">
                <h3 className="text-[15px] font-semibold text-gray-900 dark:text-gray-100">Token Created</h3>
            ...
            <div className="px-6 py-5 space-y-5 overflow-y-auto flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 min-w-0 bg-gray-50 dark:bg-gray-800/50 rounded-xl px-3.5 py-2.5">
                    <code className="text-[11px] text-gray-600 dark:text-gray-300 font-mono break-all select-all leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 min-w-0 bg-gray-50 dark:bg-gray-800/50 rounded-xl px-3.5 py-2.5">
                    <code className="text-[10px] text-gray-600 dark:text-gray-300 font-mono break-all select-all leading-relaxed">
                      {showToken
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 min-w-0 bg-gray-50 dark:bg-gray-800/50 rounded-xl px-3.5 py-2">
              ...
              {/* Warning */}
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/30 rounded-xl px-4 py-3">
            ...
            <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800 shrink-0">
              <button
                ...
                className="w-full py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-[13px] font-medium rounded-xl hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
              >
                Done
              </button>
            </div>
              ...
              <div key={token.id} className={cn('px-5 sm:px-6 py-4 flex flex-col sm:flex-row sm:items-center gap-3', expired && 'opacity-50')}>
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-[14px] font-medium text-gray-900 dark:text-gray-100">{token.name}</p>
                ...
                <div className="flex items-center gap-1 ml-4 sm:ml-0 shrink-0">
                  <span className="text-[10px] font-medium text-gray-400 bg-gray-50 dark:bg-gray-800/50 px-2 py-1 rounded mr-1">
                    read-only
                  </span>
                  <button
                    onClick={() => {
                    ...
                    className="p-2 rounded-lg text-red-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors disabled:opacity-30"
                    title="Revoke"
                  >
